...
{else}
    <table class="form-layout">
        ...
        {if $form.option_group_restriction}
        <tr class="crm-uf_group-form-block-option_group_restriction" >
            <td class="label">{$form.option_group_restriction.label}</td>
            <td class="html-adjust">
                {ts}Show only if user{/ts}
                {$form.option_group_restriction_pos.html}
                {ts}a member of{/ts}<br />
                {$form.option_group_restriction.html}
            </td>
        </tr>
        {/if}
    </table>
